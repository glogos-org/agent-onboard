...
Previous release: contributor admission dry-run product gate. The public contributor admission dry-run surface remains available as `agent-onboard contributor --admission-dry-run`, `agent-onboard contributor --admission-dry-run --json`, and `agent-onboard contributor --admission-dry-run --text`.

CI surface boundary summary: without creating workflow files, calling GitHub API, running npm, running shell commands, network, Git mutation, file writes, or publish.
