...
function createClosedGatePrunePlanRuntime(ctx = Object.freeze({})) {
  const { PACKAGE_NAME, RELEASE_LINE, VERSION, packageRoot, readJson, sourceContext, publicClosedGateArtifactFiles, publicClosedGateArchiveReaderCheck, publicFullTestRunnerCompletionCheck, readPublicClosedGateArchiveJsonl, textFileId } = ctx;
...
function publicClosedGateRawArtifactPrunePlanningText(result = publicClosedGateRawArtifactPrunePlanning()) {
  ...
  return Object.freeze({
    ...
    publicClosedGateRawArtifactPruneApplyArtifactPath,
...
module.exports = Object.freeze({
  createClosedGatePrunePlanRuntime
});
