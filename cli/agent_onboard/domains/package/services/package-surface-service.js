...
const PACKAGE_SURFACE_SERVICE_SEED = Object.freeze({
  ...
  owned_release_commands: Object.freeze(['release --surface', 'release --surface-check', 'release --source-manifest', 'release --source-manifest-check', 'release --artifact-oracle', 'release --artifact-oracle-check']),
