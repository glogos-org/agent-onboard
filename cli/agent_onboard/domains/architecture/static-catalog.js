...
const PUBLIC_ARCHITECTURE_MAP = Object.freeze({
  ...
  canonical_domains: Object.freeze([
    ...
    'release --readme-dry-run-check', 'release --version-sprawl-check', 'release --parity-smoke', 'release --architecture-parity-smoke', 'release --target-onboarding-smoke', 'release --post-publish-handoff', 'release --published-acceptance', 'release --real-target-trial', 'release --check']),
