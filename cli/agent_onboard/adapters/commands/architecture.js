...
const ARCHITECTURE_COMMAND_ADAPTER_EXTRACTION = Object.freeze({
  ...
  excluded_top_level_commands: Object.freeze(['help', 'version', 'status', 'commands', 'release', 'authority', 'work-items', 'target', 'target-instance', 'init', 'agents', 'bridge', 'guard', 'target-config']),
