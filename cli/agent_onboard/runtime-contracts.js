...
const RELEASE_LINE = 'public_closed_gate_artifact_compaction_dry_run_gate';
...
const PRODUCT_HELP_LINES = Object.freeze([
  ...
  'agent-onboard release --plan|--surface|--surface-check|--source-manifest|--source-manifest-check|--artifact-oracle|--artifact-oracle-check|--authority-state-parity|--authority-state-parity-check|--clean-inventory|--clean-check|--clean-catalog|--clean-catalog-check|--keyword-taxonomy|--keyword-taxonomy-check|--readme-plan|--readme-plan-check|--readme-dry-run|--readme-dry-run-check|--readme-apply|--readme-apply-check|--closed-gates-plan|--closed-gates-plan-check|--closed-gates-dry-run|--closed-gates-dry-run-check|--target-onboarding-smoke|--real-target-trial|--check',
