...
const RELEASE_LINE = 'public_clean_compaction_baseline_gate';
...
const PRODUCT_HELP_LINES = Object.freeze([
  ...
  'agent-onboard release --plan|--surface|--surface-check|--source-manifest|--source-manifest-check|--artifact-oracle|--artifact-oracle-check|--authority-state-parity|--authority-state-parity-check|--clean-inventory|--clean-check|--target-onboarding-smoke|--real-target-trial|--check',
